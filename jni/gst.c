...
static void *app_function (void *userdata) {
  ...
  /* Build pipeline */
  /*
   * Here the dimension of the videotestsrc is resized in videosink maintaing
   * the ratio between height/width
   */
  data->pipeline = gst_parse_launch(
    "videotestsrc ! video/x-raw-rgb,width=480,height=541 ! warptv ! ffmpegcolorspace ! autovideosink",
...
jint JNI_OnLoad(JavaVM *vm, void *reserved) {
  ...
  if ((*vm)->GetEnv(vm, (void**) &env, JNI_VERSION_1_4) != JNI_OK) {
    __android_log_print (ANDROID_LOG_ERROR, "GstActivity", "Could not retrieve JNIEnv");
    return 0;
  }
  jclass klass = (*env)->FindClass (env, "org/ktln2/android/gst/GstActivity");
